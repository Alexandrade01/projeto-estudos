package com.estudos.projetoestudos.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
    	...
    	String path = request.getServletPath(); // Ignora endpoints públicos 
    	
    	if (path.equals("/usuario") && request.getMethod().equals("POST") 
    			|| path.equals("/usuario/login") 
    			|| (path.equals("/auth") && request.getMethod().equals("GET"))) 
